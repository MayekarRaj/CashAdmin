  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          widget.user.name,
          style: const TextStyle(color: Color(0xFFD6DBEE)),
        ),
      ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF6F8CB0).withOpacity(0.55),
                        blurRadius: 16.0,
                      ),
                    ],
                  ),
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(26),
                              image: DecorationImage(
                                image: CachedNetworkImageProvider(widget.user.aadharBackImageUrl),
                                // Image.file(
